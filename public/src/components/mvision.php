...
<section class="text-white" style="background-color:#000066">
 ...
 <div class="container d-none d-lg-block py-5">
  <div class="row justify-content-between">
    ...
    <!-- Left Column (Mission - Move Up) -->
    <div class="col-lg-4 d-flex flex-column justify-content-start text-start">
      <div class="mb-5">
        <img src="../../main/images/mission_and_vission_section/mission2.png" 
             alt="Mission Image" 
             class="img-fluid">
    ...
    <!-- Middle Image Column (Center Vertically) -->
    <div class="col-lg-4 d-flex justify-content-center align-items-center">
      <img src="../../main/images/mission_and_vission_section/about_image.png" 
           alt="Middle Image" 
           class="img-fluid" style="max-width:100%">
    </div>

    <!-- Right Column (Vision - Move Down) -->
    <div class="col-lg-4 d-flex flex-column justify-content-end text-end">
      <div class="mt-5"> 
        <img src="../../main/images/mission_and_vission_section/vision2.png" 
             alt="Vision Image" 
             class="img-fluid">
...
<div class="container d-lg-none py-5">
  <div class="row justify-content-center text-center">
    ...
    <!-- About Image (Middle, Centered) -->
    <div class="col-12 my-5 mb-5">
      <img src="../../main/images/mission_and_vission_section/about_image.png" 
           alt="About Image" 
           class="img-fluid" style="max-width: 350px;">
    </div>

    <!-- Vision (Bottom, Centered) -->
    <div class="col-12">
      <img src="../../main/images/mission_and_vission_section/vision2.png" 
           alt="Vision Image" 
           class="img-fluid mb-3">
