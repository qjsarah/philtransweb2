...
$key = 'test_img'; // intro section key

$stmt = $conn->prepare("SELECT * FROM testimonial_archive WHERE key_name = ? ORDER BY created_at DESC");
$stmt->bind_param("s", $key);
$stmt->execute();
$result = $stmt->get_result();
?>
<div class="container text-primary">
    <h1 class="my-3">Archived Images for Testimonial Section</h1>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="col">
                <div class="card h-auto p-3 shadow">
                    <img src="/philtransweb2/public/main/images/testimonial_section/archive/<?php echo htmlspecialchars($row['file_name']); ?>" 
                        class="card-img-top" 
                        alt="Archived Image">
                    ...
                    <div class="text-center">
                        <form method="POST" action="../../backend/admin_dashboard/restore_testimonial.php" class="d-inline">
