...
<table border="1" cellpadding="10">
    ...
    <tr>
        <td>
            <img src="/philtrans/philtransweb2/public/main/images/mission_and_vission_section/archive/<?php echo htmlspecialchars($row['file_name']); ?>" width="100">
        </td>
        <td><?php echo htmlspecialchars($row['file_name']); ?></td>
        <td><?php echo $row['created_at']; ?></td>
        <td>
             <form method="POST" action="../../backend/admin_dashboard/restore_mvision.php">
