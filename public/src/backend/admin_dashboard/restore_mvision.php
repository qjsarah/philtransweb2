...
if (isset($_POST['id'], $_POST['key_name'])) {
    ...
    $stmt = $conn->prepare("SELECT file_name FROM missionvision_archive WHERE id=? AND key_name=?");
    ...
    if ($restoreFile) {
        ...
        $archiveDir = $rootPath . "/public/main/images/mission_and_vission_section/archive/";
        $uploadDir  = $rootPath . "/public/main/images/mission_and_vission_section/";
        ...
        if (file_exists($archivePath)) {
            ...
            $stmt = $conn->prepare("DELETE FROM missionvision_archive WHERE id=?");
...
header("Location: ../../components/admin_dashboard/mvision_archive.php");
exit;
